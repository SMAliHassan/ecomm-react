...
const LocalPrice = () => {
  const columns = [
    { name: 'Store Name', header: 'Store Name', minWidth: 210 },
    {
      name: 'Authorization Status',
      header: 'Authorization Status',
      minWidth: 150,
    },
    { name: 'Country/Region', header: 'Country/Region', minWidth: 135 },
    { name: 'Authorized At', header: 'Authorized At', minWidth: 100 },
    {
      name: 'Authorization Validity Period',
      header: 'Authorization Validity Period',
      minWidth: 170,
    },
  ];
